...
import { ArrowRight, CircleArrowOutUpRight, MapPin } from "lucide-react";
  ...
  return (
    <div className="relative py-12 lg:py-0 flex flex-col justify-between h-full">
      ...
      <div>
        ...
        <div className="mt-12 flex items-center gap-2 border w-fit px-4 py-2">
          ...
          <Link
            ...
            className="hover:underline hover:text-black flex items-center text-sm text-neutral-600" 
          >
            Get Started here
